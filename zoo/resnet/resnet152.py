...
from tensorflow.keras.layers import Add, Dense, GlobalAveragePooling2D
...
def identity_block(x, n_filters):
    """ Construct a Bottleneck Residual Block of with Identity Link
...
def projection_block(x, n_filters, strides=(2,2)):
    """ Construct a Bottleneck Residual Block of with Projection Shortcut
        Increase the number of filters by 4X
        x        : input into the block
        n_filters: number of filters
        strides  : whether a strided convolution
    """
