...
from tensorflow.keras.layers import Conv2D, MaxPooling2D, BatchNormalization, ReLU, MaxPooling2D
from tensorflow.keras.layers import Add, Dense, GlobalAveragePooling2D, Concatenate, Lambda
