...
# Learner
# Shuffle Group: 2 partitions, 4 blocks, 128 filters
x = ShuffleNet.group(x, n_parttitions=2, n_blocks=4, n_filters=128, reduction=0.25)
# Shuffle Block: 2 partitions, 256 filters, strided
# Shuffle Block: 2 partitions, 256 filters, non-strided
x = ShuffleNet.strided_shuffle_block(x, n_paritisions=2, n_filters=256, reduction=0.25)
x = ShuffleNet.shuffle_block(x, n_partitions=2, n_filters=256, reduction=0.25)
...
Epoch 6/10
45000/45000 [==============================] - 218s 5ms/sample - loss: 0.6048 - acc: 0.7880 - val_loss: 0.9158 - val_acc: 0.7000
Epoch 7/10
45000/45000 [==============================] - 223s 5ms/sample - loss: 0.5157 - acc: 0.8199 - val_loss: 0.9950 - val_acc: 0.6806
Epoch 8/10
45000/45000 [==============================] - 221s 5ms/sample - loss: 0.4334 - acc: 0.8462 - val_loss: 0.9663 - val_acc: 0.7048
Epoch 9/10
45000/45000 [==============================] - 223s 5ms/sample - loss: 0.3650 - acc: 0.8709 - val_loss: 1.0122 - val_acc: 0.7050
Epoch 10/10
45000/45000 [==============================] - 232s 5ms/sample - loss: 0.3022 - acc: 0.8925 - val_loss: 1.0214 - val_acc: 0.7070
```
